...
def test_sim_file_creation(local):
    ghosts_connect = GHOSTSConnection(num_attackers=1, num_defenders=1, local_session=local, test_session=True)
...
def test_sim_file_write(local):
    ghosts_connect = GHOSTSConnection(1, 1, local_session=local, test_session=True)

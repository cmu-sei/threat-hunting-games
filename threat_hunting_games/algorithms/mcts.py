...
flags.DEFINE_string("game", current_game.game_name, "Name of the game.")
...
def main(argv):
  ...
  bots = [
      _init_bot(FLAGS.player1, game, current_game.Players.ATTACKER),
      _init_bot(FLAGS.player2, game, current_game.Players.DEFENDER),
  ]
